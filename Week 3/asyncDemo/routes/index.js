...
/*
 ...
 The asyncDemo package provides quite a few methods for managing asynchronous calls. We're
 using asyncDemo.waterfall here which runs a series of functions in order, passing results
 to each one in turn
 */
const request = require('request-promise-lite')
//const async = require('asyncDemo')
...
/*
 ...
 for asyncDemo.waterfall is ([array of functions in order], final function (optional))
